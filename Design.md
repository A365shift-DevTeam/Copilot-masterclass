...
| Shade | Hex | Token Variable |
|-------|-----|----------------|
| 50 | `#f5f7f9` | `--color-secondary-50` |
| 100 | `#eceff4` | `--color-secondary-100` |
| 200 | `#d2dae4` | `--color-secondary-200` |
| 300 | `#b1bfd3` | `--color-secondary-300` |
| 400 | `#8299ba` | `--color-secondary-400` |
| 500 | `#5c7aa3` | `--color-secondary-500` |
| 600 | `#4d6689` | `--color-secondary-600` |
| 700 | `#3f536f` | `--color-secondary-700` |
| 800 | `#303f55` | `--color-secondary-800` |
| 900 | `#1f2937` | `--color-secondary-900` |
| 950 | `#192029` | `--color-secondary-950` |
...
| xl | `rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, rgba(0, 0, 0, 0) 0px 0px 0px 0px, oklch(0.373 0.034 259.733) 0px 0px 0px 1px, rgba(0, 0, 0, 0.1) 0px 1px 3px 0px, rgba(0, 0, 0, 0.1) 0px 1px 2px -1px` | `--shadow-xl` |
