/**
 * The audience glyph set: one line-art mark per AUDIENCE entry, keyed by its
 * `icon` field. Lives here because two sections draw the same people — the
 * Audience grid at full size and the Benefits chips at chip size.
 */
const ICONS = {
  owner: (
    <>
...
/** One glyph on a shared 24px canvas; decorative, so it is hidden from AT. */
export default function AudienceGlyph({ icon }) {
  return (
