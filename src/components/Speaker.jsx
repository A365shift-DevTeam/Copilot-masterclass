  ...
  return (
    <section id="speaker" className="speaker-section">
      ...
      <svg className="speaker-section__svg" viewBox="0 0 800 400" preserveAspectRatio="xMidYMid slice">
        <g stroke="#128CA8" strokeWidth="1" fill="none" strokeOpacity="0.55">
        ...
        <path d="M40 340 H180 V220 H320 V120 H520 V240 H700" stroke="#8BBF2F" strokeWidth="2" fill="none" strokeDasharray="24 300" style={{ animation: 'om-flow 6s linear infinite' }} />
      </svg>
