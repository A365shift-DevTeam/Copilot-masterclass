...
export const APP_CARDS = [
  { mark: 'X', title: 'Microsoft Excel', color: '#599138', tint: '#EEF7E0', points: ['Analyse data', 'Create formulas', 'Identify trends', 'Generate summaries', 'Automate repetitive work'] },
  { mark: 'W', title: 'Microsoft Word', color: '#0C576A', tint: '#D4EEF5', points: ['Generate documents', 'Rewrite content', 'Summarise information', 'Improve communication'] },
  { mark: 'P', title: 'Microsoft PowerPoint', color: '#599138', tint: '#EEF7E0', points: ['Generate presentations', 'Create slide structures', 'Summarise documents into decks'] },
  { mark: 'O', title: 'Microsoft Outlook', color: '#0C576A', tint: '#D4EEF5', points: ['Draft emails', 'Summarise threads', 'Prioritise communication'] },
  { mark: 'T', title: 'Microsoft Teams', color: '#599138', tint: '#EEF7E0', points: ['Meeting summaries', 'Action items', 'Collaboration assistance'] },
  { mark: 'B', title: 'Microsoft Power BI', color: '#0C576A', tint: '#D4EEF5', points: ['AI-assisted analysis', 'Business insights', 'Data storytelling'] },
  { mark: 'A', title: 'Power Automate', color: '#599138', tint: '#EEF7E0', points: ['Workflow automation', 'Approvals', 'Notifications', 'Microsoft 365 integration'] },
  { mark: 'S', title: 'SharePoint', color: '#0C576A', tint: '#D4EEF5', points: ['Knowledge management', 'Enterprise content', 'Copilot-powered search'] },
]
